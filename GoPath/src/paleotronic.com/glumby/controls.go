...
// Joystick IDs
const (
	Joystick1    Joystick = Joystick(glfw.Joystick1)
	Joystick2    Joystick = Joystick(glfw.Joystick2)
	Joystick3    Joystick = Joystick(glfw.Joystick3)
	Joystick4    Joystick = Joystick(glfw.Joystick4)
	Joystick5    Joystick = Joystick(glfw.Joystick5)
	Joystick6    Joystick = Joystick(glfw.Joystick6)
	Joystick7    Joystick = Joystick(glfw.Joystick7)
	Joystick8    Joystick = Joystick(glfw.Joystick8)
	Joystick9    Joystick = Joystick(glfw.Joystick9)
	Joystick10   Joystick = Joystick(glfw.Joystick10)
	Joystick11   Joystick = Joystick(glfw.Joystick11)
	Joystick12   Joystick = Joystick(glfw.Joystick12)
	Joystick13   Joystick = Joystick(glfw.Joystick13)
	Joystick14   Joystick = Joystick(glfw.Joystick14)
	Joystick15   Joystick = Joystick(glfw.Joystick15)
	Joystick16   Joystick = Joystick(glfw.Joystick16)
	JoystickLast Joystick = Joystick(glfw.JoystickLast)
)
...
type KeyTranslationMap []KeyState

func NewDefaultMapper() KeyTranslationMap {

	this := make(KeyTranslationMap, 0)

	this = append(this, KeyState{Key: KeyEnter, Modifier: 0, States: []Action{Release, Repeat}, Mapping: '\r'})
	this = append(this, KeyState{Key: KeyTab, Modifier: 0, States: []Action{Release, Repeat}, Mapping: '\t'})
	this = append(this, KeyState{Key: KeyBackspace, Modifier: 0, States: []Action{Release, Repeat}, Mapping: 127})
	this = append(this, KeyState{Key: KeyEscape, Modifier: 0, States: []Action{Release, Repeat}, Mapping: 27})
	this = append(this, KeyState{Key: KeyC, Modifier: ModControl, States: []Action{Release, Repeat}, Mapping: 3})

	return this
}

// Returns a rune for the combination of keystates
func (m KeyTranslationMap) GetMapping(key Key, mod ModifierKey, action Action) (rune, bool) {

	//fmt.Printf("GetMapping called for KeyCode=%d, ModKey=%d, Action=%d\n", key, mod, action)

	for _, mapping := range m {
		if key == mapping.Key && mod == mapping.Modifier {
			for _, a := range mapping.States {
				if a == action {
					//fmt.Printf("Match key=%v, mod=%v, action=%v\n", key, mod, action)
