...
type StandardCommandQUAD struct {
	dialect.Command
	solid bool
}

func (this *StandardCommandQUAD) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
...
func (this *StandardCommandQUAD) Syntax() string {
