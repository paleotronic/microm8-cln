...
type StandardCommandPENUP struct {
	dialect.Command
}

func (this *StandardCommandPENUP) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
...
func (this *StandardCommandPENUP) Syntax() string {
