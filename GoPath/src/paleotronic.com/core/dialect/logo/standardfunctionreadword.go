...
type StandardFunctionREADWORD struct {
	dialect.CoreFunction
}

func (this *StandardFunctionREADWORD) FunctionParams() []types.TokenType {
...
func NewStandardFunctionREADWORD(a int, b int, params types.TokenList) *StandardFunctionREADWORD {
	this := &StandardFunctionREADWORD{}
...
func (this *StandardFunctionREADWORD) FunctionExecute(params *types.TokenList) error {
...
func (this *StandardFunctionREADWORD) Syntax() string {

	/* vars */
	var result string

	result = "READWORD word list"
...
func (this *StandardFunctionREADWORD) GetCRTLine(caller interfaces.Interpretable) string {
