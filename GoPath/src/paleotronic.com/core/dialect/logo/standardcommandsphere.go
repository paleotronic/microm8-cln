...
type StandardCommandSPHERE struct {
	dialect.Command
	solid bool
}

func (this *StandardCommandSPHERE) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
...
func (this *StandardCommandSPHERE) Syntax() string {
