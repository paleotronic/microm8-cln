...
type StandardCommandFD struct {
	dialect.Command
}

func (this *StandardCommandFD) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
...
func (this *StandardCommandFD) Syntax() string {
