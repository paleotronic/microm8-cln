...
type StandardCommandCHEADING struct {
	dialect.Command
}

func (this *StandardCommandCHEADING) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
...
func (this *StandardCommandCHEADING) Syntax() string {
