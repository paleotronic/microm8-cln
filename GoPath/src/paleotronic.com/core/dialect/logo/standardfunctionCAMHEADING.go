...
type StandardFunctionCAMHEADING struct {
	dialect.CoreFunction
}

func (this *StandardFunctionCAMHEADING) FunctionParams() []types.TokenType {
...
func NewStandardFunctionCAMHEADING(a int, b int, params types.TokenList) *StandardFunctionCAMHEADING {
	this := &StandardFunctionCAMHEADING{}
...
func (this *StandardFunctionCAMHEADING) FunctionExecute(params *types.TokenList) error {
...
func (this *StandardFunctionCAMHEADING) Syntax() string {
