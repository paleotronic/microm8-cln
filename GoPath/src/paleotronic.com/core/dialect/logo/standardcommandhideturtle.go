...
type StandardCommandHIDETURTLE struct {
	dialect.Command
}

func (this *StandardCommandHIDETURTLE) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
...
func (this *StandardCommandHIDETURTLE) Syntax() string {
