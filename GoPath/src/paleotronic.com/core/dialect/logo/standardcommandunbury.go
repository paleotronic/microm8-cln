...
type StandardCommandUNBURY struct {
	dialect.Command
	Split bool
	Local bool
}

func (this *StandardCommandUNBURY) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
...
func (this *StandardCommandUNBURY) Syntax() string {
