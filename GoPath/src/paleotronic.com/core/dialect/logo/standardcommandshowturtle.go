...
type StandardCommandSHOWTURTLE struct {
	dialect.Command
}

func (this *StandardCommandSHOWTURTLE) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
	...
	apple2helpers.VECTOR(caller).GetTurtle( this.Command.D.(*DialectLogo).Driver.GetTurtle() ).SetShow()
...
func (this *StandardCommandSHOWTURTLE) Syntax() string {
