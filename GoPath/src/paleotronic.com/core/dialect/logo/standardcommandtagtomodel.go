...
type StandardCommandSETMODEL struct {
	dialect.Command
}

func (this *StandardCommandSETMODEL) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
...
func (this *StandardCommandSETMODEL) Syntax() string {
