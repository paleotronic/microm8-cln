...
type PlusBugComment struct {
	dialect.CoreFunction
}

func (this *PlusBugComment) FunctionExecute(params *types.TokenList) error {
...
func (this *PlusBugComment) Syntax() string {
...
func (this *PlusBugComment) FunctionParams() []types.TokenType {
...
func NewPlusBugComment(a int, b int, params types.TokenList) *PlusBugComment {
	this := &PlusBugComment{}
