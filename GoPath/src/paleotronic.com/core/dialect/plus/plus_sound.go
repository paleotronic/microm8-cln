...
type PlusSound struct {
	dialect.CoreFunction
}

func (this *PlusSound) FunctionExecute(params *types.TokenList) error {
	...
	cmd := fmt.Sprintf(`
use mixer.voices.beep
set instrument "WAVE=SQUARE:VOLUME=1.0:ADSR=0,0,%d,1"
set frequency %d
set volume 1.0
	`, duration, pitch)
...
func (this *PlusSound) Syntax() string {
...
func (this *PlusSound) FunctionParams() []types.TokenType {
...
func NewPlusSound(a int, b int, params types.TokenList) *PlusSound {
	this := &PlusSound{}
