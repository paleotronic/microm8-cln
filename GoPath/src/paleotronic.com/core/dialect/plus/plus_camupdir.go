...
type PlusCamUpDir struct {
	dialect.CoreFunction
}

func (this *PlusCamUpDir) FunctionExecute(params *types.TokenList) error {
	...
	if this.Query {
		...
		// control.SetUpDir(mgl64.Vec3{x, y, z})
...
func (this *PlusCamUpDir) Syntax() string {
...
func (this *PlusCamUpDir) FunctionParams() []types.TokenType {
...
func NewPlusCamUpDir(a int, b int, params types.TokenList) *PlusCamUpDir {
	this := &PlusCamUpDir{}
