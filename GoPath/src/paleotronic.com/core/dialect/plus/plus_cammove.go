...
type PlusCamMove struct {
	dialect.CoreFunction
}

func (this *PlusCamMove) FunctionExecute(params *types.TokenList) error {
...
func (this *PlusCamMove) Syntax() string {

	/* vars */
	var result string

	result = "CAMMOVE{x,y,z}"
...
func (this *PlusCamMove) FunctionParams() []types.TokenType {
...
func NewPlusCamMove(a int, b int, params types.TokenList) *PlusCamMove {
	this := &PlusCamMove{}
