...
func (this *PlusGrant) Syntax() string {

	/* vars */
	var result string

	result = "GRANT{username,mode,group}"
...
func (this *PlusGrant) FunctionParams() []types.TokenType {
...
func NewPlusGrant(a int, b int, params types.TokenList) *PlusGrant {
	this := &PlusGrant{}
