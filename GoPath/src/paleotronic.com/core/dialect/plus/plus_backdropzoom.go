...
type PlusBackdropZoom struct {
	dialect.CoreFunction
}

func (this *PlusBackdropZoom) FunctionExecute(params *types.TokenList) error {
	...
	if !this.Query {
		...
		_, backdrop, camidx, opacity, _, zoomf, camtrack := this.Interpreter.GetMemoryMap().IntGetBackdrop(index)
...
func (this *PlusBackdropZoom) Syntax() string {
...
func (this *PlusBackdropZoom) FunctionParams() []types.TokenType {
...
func NewPlusBackdropZoom(a int, b int, params types.TokenList) *PlusBackdropZoom {
	this := &PlusBackdropZoom{}
