...
type PlusAppDBQuerySub struct {
	dialect.CoreFunction
}

func (this *PlusAppDBQuerySub) FunctionExecute(params *types.TokenList) error {
	...
	if !this.Query {
		...
		stmtid, e = s8webclient.CONN.AppDatabaseQuery("DQS", handle, appsig, query)
...
func (this *PlusAppDBQuerySub) Syntax() string {
...
func (this *PlusAppDBQuerySub) FunctionParams() []types.TokenType {
...
func NewPlusAppDBQuerySub(a int, b int, params types.TokenList) *PlusAppDBQuerySub {
	this := &PlusAppDBQuerySub{}
