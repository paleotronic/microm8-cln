...
type PlusCamLoc struct {
	dialect.CoreFunction
}

func (this *PlusCamLoc) FunctionExecute(params *types.TokenList) error {
...
func (this *PlusCamLoc) Syntax() string {
...
func (this *PlusCamLoc) FunctionParams() []types.TokenType {
...
func NewPlusCamLoc(a int, b int, params types.TokenList) *PlusCamLoc {
	this := &PlusCamLoc{}
