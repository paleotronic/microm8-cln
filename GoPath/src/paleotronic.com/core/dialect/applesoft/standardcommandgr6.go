...
type StandardCommandGR6 struct {
	dialect.Command
}

func (this *StandardCommandGR6) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
	...
	apple2helpers.CubeLayerEnableCustom(caller, true, true, 96, 96)
...
func (this *StandardCommandGR6) Syntax() string {
