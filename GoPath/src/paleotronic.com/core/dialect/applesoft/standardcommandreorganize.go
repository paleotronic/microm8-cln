...
type StandardCommandREORGANIZE struct {
	dialect.Command
}

func NewStandardCommandREORGANIZE() *StandardCommandREORGANIZE {
	this := &StandardCommandREORGANIZE{}
	this.ImmediateMode = true
	return this
}

func (this *StandardCommandREORGANIZE) PadLeft(str string, width int) string {
	for len(str) < width {
		str = " " + str
	}
...
func (this *StandardCommandREORGANIZE) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
...
func (this *StandardCommandREORGANIZE) Syntax() string {
