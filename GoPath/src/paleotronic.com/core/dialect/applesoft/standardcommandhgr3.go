...
type StandardCommandHGR3 struct {
	dialect.Command
}

func (this *StandardCommandHGR3) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {

	var result int = 0

	//caller.PutStr(string(rune(4)) + "PR#3\r\n")
	//log.Printf("HGR3 called")
...
func (this *StandardCommandHGR3) Syntax() string {
