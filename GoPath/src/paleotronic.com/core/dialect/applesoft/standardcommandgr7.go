...
type StandardCommandGR7 struct {
	dialect.Command
}

func (this *StandardCommandGR7) Execute(env *interfaces.Producable, caller interfaces.Interpretable, tokens types.TokenList, Scope *types.Algorithm, LPC types.CodeRef) (int, error) {
	...
	apple2helpers.CubeLayerEnableCustom(caller, true, true, 128, 128)
...
func (this *StandardCommandGR7) Syntax() string {
